...
import { LayoutDashboard, Wallet, Users, Plus, Folder } from 'lucide-react';
import Modal from './Modal';
import Toast from './Toast';

export const Sidebar: React.FC = () => {
  const { groups, fetchGroups, createGroup, isAuthenticated } = useStore();
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '2rem', padding: '0 0.5rem' }}>
        <h2 style={{ color: '#ffffff', fontSize: '1.25rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
